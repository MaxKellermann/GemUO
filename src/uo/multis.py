...
def multi_passable_at(item_id, x, y, z):
    ...
    if item_id == 0x98 or item_id == 0xa3 or item_id == 0xc4 or item_id == 0xc2 or item_id == 0xc5 or item_id == 0xa4 or item_id == 0xa8 or item_id in (0xa6, 0xad, 0xb4, 0xb5, 0xb8, 0xbb, 0xc3):
